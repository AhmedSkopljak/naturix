            ...
            <div className={"flex flex-col gap-5 m-auto items-start p-8 py-12 min-w-80 sm:min-w-88 rounded-lg shadow-xl border border-gray-200"}>
                ...
                <div className={"w-full"}>
                    ...
                    <input onChange={(e) => setEmail(e.target.value)} value={email} type="email" placeholder={"example@gmail.com"} className={"border" +
                        " border-gray-200 rounded w-full p-2 mt-1 outline-primary"} required/>
                </div>
                <div className={"w-full"}>
                    <p>Password</p>
                    <input onChange={(e) => setPassword(e.target.value)} value={password} type="password" placeholder={"Enter your password"} className={"border" +
                        " border-gray-200 rounded w-full p-2 mt-1 outline-primary"} required/>
                </div>

    ...
    return (
        <div className={"mt-16 pb-16"}>
            ...
            <div className={"flex flex-col-reverse md:flex-row justify-between mt-10"}>
                <div className={"flex-1 max-w-md"}>
                    <form onSubmit={onSubmitHandler} className={"space-y-3 mt-6 text-sm"}>
                        <div className={"grid grid-cols-2 gap-4"}>
                            <InputFiled handleChange={handleChange} address={address} name={"firstName"} type={"text"} placeholder={"First Name"}/>
                            <InputFiled handleChange={handleChange} address={address} name={"lastName"} type={"text"} placeholder={"Last Name"}/>
                        </div>
                ...
                <img className={"md:mr-16 mb-16 md:mt-0 w-1/3"} src={assets.add_address_image} alt="add adress image"/>
            </div>
        </div>
    );
}
